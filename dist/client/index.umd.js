(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('events'), require('fs'), require('path'), require('axios'), require('faker'), require('lodash.get')) :
  typeof define === 'function' && define.amd ? define(['exports', 'events', 'fs', 'path', 'axios', 'faker', 'lodash.get'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.MockerApp = {}, global.EventEmitter, global.fs, global.path, global.axios, global.faker, global.get));
}(this, (function (exports, EventEmitter, fs, path, axios, faker, get) { 'use strict';
  ...
  exports.MockerClient = MockerClient;
