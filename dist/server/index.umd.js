(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@hapi/hapi'), require('events'), require('fs'), require('path'), require('axios'), require('faker'), require('lodash.get')) :
  typeof define === 'function' && define.amd ? define(['exports', '@hapi/hapi', 'events', 'fs', 'path', 'axios', 'faker', 'lodash.get'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.MockerApp = {}, global.hapi, global.EventEmitter, global.fs, global.path, global.axios, global.faker, global.get));
}(this, (function (exports, hapi, EventEmitter, fs, path, axios, faker, get) { 'use strict';
  ...
  var MockerService = /*@__PURE__*/(function (EventEmitter) {
    ...
    MockerService.prototype.startService = function startService (opts) {
      ...
      if (typeof options === 'string') {
        var json = fs__default['default'].readFileSync(options, { encoding:'utf8' });
  ...
  var MockerCore = /*@__PURE__*/(function (EventEmitter) {
    ...
    MockerCore.prototype.registerServices = function registerServices () {
      ...
      if (this._servicesPath) {
        var pahtJoin = path__default['default'].join(this._servicesPath);
        fs__default['default'].readdirSync(pahtJoin).forEach(function (file) {
